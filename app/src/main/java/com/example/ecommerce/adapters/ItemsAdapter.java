...
public class ItemsAdapter extends RecyclerView.Adapter<ItemsAdapter.ViewHolder>{
    ...
    public ItemsAdapter(Context context , List<ItemModel> items , onProdactDetailsListner onProdactDetailsListner) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_card_activity , parent ,false) ;
    ...
    public class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        public ViewHolder(@NonNull View itemView ,  onProdactDetailsListner onProdactDetailsListner ) {
            ...
            linearLayout = itemView.findViewById(R.id.prodact_card);
            this.onProdactDetailsListner = onProdactDetailsListner ;
